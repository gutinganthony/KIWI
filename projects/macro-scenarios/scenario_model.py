...
#
# 更新依據：核心 CPI 6–8 月三月年化 2.02%、核心 PCE 5–7 月三月年化 2.43%（皆自行計算）。
# 給 cool 偏高的理由：兩個指標當下動能都已在 2% 出頭，且住房落後效應還有下行空間。
# ⚠️ 但住房那塊的下行空間有爭議（見 topics/business/ 的機制查核），所以沒有給更高。
P_CORE_HOT_GIVEN_OIL = {"down": 0.15, "sticky": 0.35, "up": 0.75}
