...
#   ⚠️ **兩把尺（動能口徑）差 0.89pp，而答案完全取決於用哪一把：**
#       註：「1985 年以來最大」只成立於**年增率**口徑（+0.88pp，2026-07；次高 2010-05 為 0.697pp）。
#       動能口徑下 2026-03 的 1.52pp、06 的 1.29pp、02 的 1.25pp、05 的 1.16pp 都比現在大。
