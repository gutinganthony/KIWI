...
（表中是成長半衰期 5 年；半衰期 3→8 年影響 ≤2pp。）**風險溢酬是最敏感的參數**；但不管怎麼設，市場押的都是歷史的 2–4 倍。
...
- **不對稱**（F7）：市場押「會變好」時，押越大越準（缺口 +3–10pp：方向對 72%；+10–20pp：86%；>+20pp：93%），兌現約押注的 40–60%；
