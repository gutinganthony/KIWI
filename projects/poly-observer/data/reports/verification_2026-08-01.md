# Polymarket 聰明錢存在性檢驗 — 2026-08-01
...
| 端點 | 成功 | 失敗 | 失敗樣本 |
|---|---:|---:|---|
| `data-api.polymarket.com/activity` | 155 | 0 | — |
...
|---|---:|---:|---:|---:|---|---|
| `0x2005d16a84ceefa912d4e380cd32e7ff827875ea` | $12,344,358 | 100% | 10% | 1,385.0 | other (62%) | 否 |
| `0x6ffb4354cbe6e0f9989e3b55564ec5fb8646a834` | $684,708 | 91% | 28% | 669.5 | crypto (62%) | 否 |
