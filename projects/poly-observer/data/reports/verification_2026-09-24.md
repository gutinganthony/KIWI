# Polymarket 聰明錢存在性檢驗 — 2026-09-24
...
| 端點 | 成功 | 失敗 | 失敗樣本 |
|---|---:|---:|---|
| `data-api.polymarket.com/activity` | 164 | 0 | — |
...
|---|---:|---:|---:|---:|---|---|
| `0x2005d16a84ceefa912d4e380cd32e7ff827875ea` | $13,961,805 | 100% | 10% | 1,406.0 | esports (60%) | 否 |
| `0xee00ba338c59557141789b127927a55f5cc5cea1` | $3,263,096 | 83% | 44% | 442.0 | other (63%) | 否 |
| `0x4f1d5ae26fc31472966e951af3183308736d8de2` | $1,778,818 | 83% | 36% | 551.0 | other (35%) | 否 |
| `0x6ffb4354cbe6e0f9989e3b55564ec5fb8646a834` | $630,255 | 83% | 28% | 481.5 | other (50%) | 否 |
