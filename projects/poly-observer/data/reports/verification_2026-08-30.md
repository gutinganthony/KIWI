# Polymarket 聰明錢存在性檢驗 — 2026-08-30
...
| 端點 | 成功 | 失敗 | 失敗樣本 |
|---|---:|---:|---|
| `data-api.polymarket.com/activity` | 163 | 0 | — |
...
|---|---:|---:|---:|---:|---|---|
| `0x2005d16a84ceefa912d4e380cd32e7ff827875ea` | $13,284,889 | 100% | 10% | 1,239.0 | other (65%) | 否 |
| `0xb55fa1296e6ec55d0ce53d93b9237389f11764d4` | $1,030,931 | 100% | 17% | 1,448.0 | crypto (100%) | 否 |
