...
> 純唯讀診斷（2026-08-07，探測時間 2026-08-07T23:22:29.715108+00:00）。
...
|---|---:|---:|
| day | $895.71 | $0.00 |
| week | $895.71 | $834,733.29 |
| month | $895.71 | $3,781,069.89 |
| allTime | $895.71 | $18,939,999,207.13 |
| perpDay | $0.00 | $0.00 |
| perpWeek | $0.00 | $834,733.29 |
...
|---|---|---:|---:|
| send | in | 3 | $31,999.40 |
| rewardsClaim | in | 12 | $4,276.67 |

**無外轉紀錄** — 近 45 天內查無任何 withdraw／轉到其他地址／vault 存入／跨層轉移／無法分類的帳變動。

## (c) 是否仍在交易？

- 最後成交時間：**2026-08-04T15:13:51.918000+00:00**（距今 3.34 天）
- 近 7 天成交：**80** 筆／近 30 天：**480** 筆（回應共 2000 筆，已達 API 截斷上限）
