...
> 純唯讀診斷（2026-09-01，探測時間 2026-09-01T01:28:07.554893+00:00）。
...
|---|---:|---:|---:|
| 原生永續 dex | $4,148.79 | 1 | $104,319.50 |
...
| 現貨 spot | $4,159.20（含估算） | 5 幣 | — |
| **合計** | **$8,307.99** | **1** | — |

非原生（builder dex＋現貨）占比：**50.1%**（$4,159.20 / $8,307.99）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,150.3857 | $4,150.39 |
| FARM | 0.8 | $4.69（估） |
| VAPOR | 816 | $3.58（估） |
...
|---|---:|---:|
| day | $4,138.13 | $0.00 |
| week | $4,138.13 | $103,204.61 |
| month | $4,138.13 | $937,937.90 |
| allTime | $4,138.13 | $18,940,102,411.74 |
| perpDay | $4,136.82 | $0.00 |
| perpWeek | $4,136.82 | $103,204.61 |
| perpMonth | $4,136.82 | $937,937.90 |
| perpAllTime | $4,136.82 | $18,932,094,824.37 |
...
|---|---|---|---:|---:|---:|
| （原生） | BTC | short | 20x | $104,319.50 | $-1,114.86 |
...
- 最後成交時間：**2026-08-29T09:13:20.864000+00:00**（距今 2.68 天）
...
- 非原生資金 $4,159.20 占總資產 $8,307.99 的50%（builder dex $0.00／現貨 $4,159.20）
- 成交戰場分布：非原生 1216/2000 筆（61%）
- 近 45 天帳變動離場訊號：跨層轉移（HyperCore→HyperEVM，同一擁有者） $4,457.57
- 跨層轉移（HyperCore→HyperEVM，同一地址擁有者，非第三方）$4,457.57，占「現餘＋跨層轉移」35%（≥ 20% 門檻）→ 資本正離開交易場（跨層/減倉）
