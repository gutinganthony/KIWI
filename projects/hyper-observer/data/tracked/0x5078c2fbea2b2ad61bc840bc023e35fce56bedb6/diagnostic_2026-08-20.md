...
> 純唯讀診斷（2026-08-20，探測時間 2026-08-20T23:07:11.350746+00:00）。
...
| day | $895.96 | $0.00 |
| week | $895.96 | $0.00 |
| month | $895.96 | $2,952,343.69 |
| allTime | $895.96 | $18,939,999,207.13 |
| perpDay | $0.00 | $0.00 |
| perpWeek | $0.00 | $0.00 |
...
| type | 方向 | 筆數 | USD |
|---|---|---:|---:|
| rewardsClaim | in | 2 | $2,504.07 |

**無外轉紀錄** — 近 45 天內查無任何 withdraw／轉到其他地址／vault 存入／跨層轉移／無法分類的帳變動。

## (c) 是否仍在交易？

- 最後成交時間：**2026-08-04T15:13:51.918000+00:00**（距今 16.33 天）
