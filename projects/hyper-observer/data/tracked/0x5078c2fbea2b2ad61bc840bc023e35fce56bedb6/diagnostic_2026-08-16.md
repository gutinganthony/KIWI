...
> 純唯讀診斷（2026-08-16，探測時間 2026-08-16T23:02:21.266078+00:00）。
...
| day | $895.76 | $0.00 |
| week | $895.76 | $0.00 |
| month | $895.76 | $3,109,980.29 |
| allTime | $895.76 | $18,939,999,207.13 |
| perpDay | $0.00 | $0.00 |
| perpWeek | $0.00 | $0.00 |
...
- 視窗內帳變動筆數：7（回應共 7 筆，json 保留 7 筆）
...
| type | 方向 | 筆數 | USD |
|---|---|---:|---:|
| rewardsClaim | in | 7 | $2,808.99 |

**無外轉紀錄** — 近 45 天內查無任何 withdraw／轉到其他地址／vault 存入／跨層轉移／無法分類的帳變動。

## (c) 是否仍在交易？

- 最後成交時間：**2026-08-04T15:13:51.918000+00:00**（距今 12.33 天）
