...
> 純唯讀診斷（2026-08-05，探測時間 2026-08-05T23:43:22.053963+00:00）。
...
|---|---:|---:|
| day | $895.74 | $0.00 |
| week | $895.74 | $1,638,528.16 |
| month | $895.74 | $3,795,007.36 |
| allTime | $895.74 | $18,939,999,207.13 |
| perpDay | $0.00 | $0.00 |
| perpWeek | $0.00 | $1,638,528.16 |
| perpMonth | $0.00 | $3,795,007.36 |
...
|---|---|---:|---:|
| send | in | 3 | $31,999.40 |
| rewardsClaim | in | 15 | $4,536.80 |

**無外轉紀錄** — 近 45 天內查無任何 withdraw／轉到其他地址／vault 存入／跨層轉移／無法分類的帳變動。

## (c) 是否仍在交易？

- 最後成交時間：**2026-08-04T15:13:51.918000+00:00**（距今 1.35 天）
- 近 7 天成交：**149** 筆／近 30 天：**481** 筆（回應共 2000 筆，已達 API 截斷上限）
