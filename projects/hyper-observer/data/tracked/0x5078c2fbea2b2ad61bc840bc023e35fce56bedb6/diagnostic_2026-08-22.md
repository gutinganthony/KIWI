...
> 純唯讀診斷（2026-08-22，探測時間 2026-08-22T23:03:04.116458+00:00）。
...
| day | $896.07 | $0.00 |
| week | $896.07 | $0.00 |
| month | $896.07 | $2,623,488.09 |
| allTime | $896.07 | $18,939,999,207.13 |
| perpDay | $0.00 | $0.00 |
| perpWeek | $0.00 | $0.00 |
| perpMonth | $0.00 | $2,623,488.09 |
...
| type | 方向 | 筆數 | USD |
|---|---|---:|---:|
| rewardsClaim | in | 1 | $2,205.31 |

**無外轉紀錄** — 近 45 天內查無任何 withdraw／轉到其他地址／vault 存入／跨層轉移／無法分類的帳變動。

## (c) 是否仍在交易？

- 最後成交時間：**2026-08-04T15:13:51.918000+00:00**（距今 18.33 天）
- 近 7 天成交：**0** 筆／近 30 天：**306** 筆（回應共 2000 筆，已達 API 截斷上限）
