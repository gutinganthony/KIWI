...
> 純唯讀診斷（2026-08-30，探測時間 2026-08-30T00:48:29.688230+00:00）。
...
|---|---:|---:|---:|
| 原生永續 dex | $4,404.15 | 1 | $104,000.29 |
...
| 現貨 spot | $4,385.02（含估算） | 5 幣 | — |
| **合計** | **$8,789.17** | **1** | — |

非原生（builder dex＋現貨）占比：**49.9%**（$4,385.02 / $8,789.17）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,376.2138 | $4,376.21 |
| FARM | 0.8 | $4.69（估） |
| VAPOR | 816 | $3.58（估） |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,377.52 | $103,204.61 |
| week | $4,377.52 | $103,204.61 |
| month | $4,377.52 | $1,741,732.77 |
| allTime | $4,377.52 | $18,940,102,411.74 |
| perpDay | $4,376.21 | $103,204.61 |
| perpWeek | $4,376.21 | $103,204.61 |
| perpMonth | $4,376.21 | $1,741,732.77 |
| perpAllTime | $4,376.21 | $18,932,094,824.37 |
...
|---|---|---|---:|---:|---:|
| （原生） | BTC | short | 20x | $104,000.29 | $-795.64 |
...
- 最後成交時間：**2026-08-29T09:13:20.864000+00:00**（距今 0.65 天）
- 近 7 天成交：**6** 筆／近 30 天：**155** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 跨層轉移（HyperCore→HyperEVM，同一地址擁有者，非第三方）$4,457.57，占「現餘＋跨層轉移」34%（≥ 20% 門檻）→ 資本正離開交易場（跨層/減倉）
