...
> 純唯讀診斷（2026-09-26，探測時間 2026-09-26T00:58:33.482285+00:00）。
...
| 現貨 spot | $8.81（含估算） | 5 幣 | — |
| **合計** | **$8.81** | **0** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$8.81 / $8.81）
...
| FARM | 0.8 | $4.69（估） |
| VAPOR | 816 | $3.58（估） |
| HYPE | 0.01437447 | $0.54（估） |
| USDC | 0.00000004 | $0.00 |
...
| day | $1.43 | $0.00 |
| week | $1.43 | $0.00 |
| month | $1.43 | $599,458.55 |
| allTime | $1.43 | $18,940,598,665.68 |
| perpDay | $0.00 | $0.00 |
| perpWeek | $0.00 | $0.00 |
| perpMonth | $0.00 | $599,458.55 |
| perpAllTime | $0.00 | $18,932,591,078.31 |

> portfolio 的 accountValue 含全部場所（原生＋builder＋現貨），perp* 視窗只含永續——兩者差額即「不在原生永續」的部分。

## (b) 有沒有轉出到其他地址？（近 45 天非資金費帳變動）

- 視窗內帳變動筆數：11（回應共 11 筆，json 保留 11 筆）
- 外轉合計（withdraw／轉他址／進 vault）：**$0.00**
- 跨層轉移合計（HyperCore→HyperEVM，同一地址擁有者，非第三方）：**$5,975.67**
- 外部入金合計：$10,737.11
...
| type | 方向 | 筆數 | USD |
|---|---|---:|---:|
| send | mixed | 5 | $11,202.46 |
| rewardsClaim | in | 6 | $5,510.31 |

查無 withdraw／轉到第三方地址／vault 存入紀錄——但這**不等於沒有資金移動**，見下方跨層轉移／無法分類項。

### 跨層轉移（HyperCore→HyperEVM，同一擁有者）：**$5,975.67**，2 筆
...
|---|---:|---|---|
| 2026-09-11T08:50:47.075000+00:00 | $1,518.10 | USDC | `0x2000000000000000000000000000000000000000` |
| 2026-08-27T12:35:48.352000+00:00 | $4,457.57 | USDC | `0x2000000000000000000000000000000000000000` |

## (c) 是否仍在交易？

- 最後成交時間：**2026-09-04T12:31:42.409000+00:00**（距今 21.52 天）
- 近 7 天成交：**0** 筆／近 30 天：**60** 筆（回應共 2000 筆，已達 API 截斷上限）
- 成交戰場分布：{'builder:xyz': 1211, 'native': 785, 'spot': 4}
- 主力幣：xyz:SP500×1118、BTC×749、xyz:GOLD×66、xyz:SPCX×27、CASHCAT×22
...
| 時間(UTC) | 幣 | 動作 | px | sz |
|---|---|---|---:|---:|
| 2026-09-04T12:31:42.409000+00:00 | BTC | Close Long | 79,680.00 | 0.61376 |
| 2026-09-04T12:31:42.409000+00:00 | CASHCAT | Close Long | 0.26933 | 58 |
| 2026-09-04T12:31:42.409000+00:00 | CASHCAT | Close Long | 0.26924 | 70 |
| 2026-09-04T12:31:42.409000+00:00 | CASHCAT | Close Long | 0.26924 | 1,000 |
| 2026-09-04T12:31:42.409000+00:00 | CASHCAT | Close Long | 0.26897 | 70 |
| 2026-09-04T12:31:42.409000+00:00 | CASHCAT | Close Long | 0.26897 | 1,000 |
| 2026-09-04T12:31:42.409000+00:00 | CASHCAT | Close Long | 0.26891 | 280 |
| 2026-09-04T12:31:42.409000+00:00 | CASHCAT | Close Long | 0.26876 | 3,704 |
| 2026-09-04T12:31:42.409000+00:00 | CASHCAT | Close Long | 0.2687 | 70 |
| 2026-09-04T12:31:42.409000+00:00 | CASHCAT | Close Long | 0.2687 | 625 |
...
- 非原生資金 $8.81 占總資產 $8.81 的100%（builder dex $0.00／現貨 $8.81）
- 成交戰場分布：非原生 1215/2000 筆（61%）
- 近 45 天帳變動離場訊號：跨層轉移（HyperCore→HyperEVM，同一擁有者） $5,975.67
- 跨層轉移（HyperCore→HyperEVM，同一地址擁有者，非第三方）$5,975.67，占「現餘＋跨層轉移」100%（≥ 20% 門檻）→ 資本正離開交易場（跨層/減倉）
