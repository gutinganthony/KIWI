...
> 純唯讀診斷（2026-08-14，探測時間 2026-08-14T23:04:16.299124+00:00）。
...
| type | 方向 | 筆數 | USD |
|---|---|---:|---:|
| rewardsClaim | in | 10 | $3,173.36 |

**無外轉紀錄** — 近 45 天內查無任何 withdraw／轉到其他地址／vault 存入／跨層轉移／無法分類的帳變動。

## (c) 是否仍在交易？

- 最後成交時間：**2026-08-04T15:13:51.918000+00:00**（距今 10.33 天）
