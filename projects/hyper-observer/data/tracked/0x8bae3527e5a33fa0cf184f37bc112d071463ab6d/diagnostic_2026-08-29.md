...
> 純唯讀診斷（2026-08-29，探測時間 2026-08-29T03:57:54.030091+00:00）。
...
| builder dex `xyz` | $692,892.14 | 3 | $1,481,218.81 |
| 現貨 spot | $4,378,895.11（含估算） | 3 幣 | — |
| **合計** | **$5,071,787.25** | **3** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,071,787.25 / $5,071,787.25）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,330,679.8489 | $4,330,679.85 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,378,889.81 | $0.00 |
| week | $4,378,889.81 | $8,705,066.24 |
| month | $4,378,889.81 | $50,240,432.49 |
| allTime | $4,378,889.81 | $349,809,663.11 |
| perpDay | $692,886.45 | $0.00 |
| perpWeek | $692,886.45 | $8,705,066.24 |
| perpMonth | $692,886.45 | $50,240,432.49 |
| perpAllTime | $692,886.45 | $341,755,306.05 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:NVDA | long | 5x | $896,388.47 | $-3,368.35 |
| xyz | xyz:INTC | long | 1x | $508,805.63 | $8,866.27 |
| xyz | xyz:GOOGL | long | 10x | $76,024.71 | $548.09 |
...
- 最後成交時間：**2026-08-26T21:08:20.358000+00:00**（距今 2.28 天）
- 近 7 天成交：**392** 筆／近 30 天：**2000** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 非原生資金 $5,071,787.25 占總資產 $5,071,787.25 的100%（builder dex $692,892.14／現貨 $4,378,895.11）
