...
> 純唯讀診斷（2026-09-05，探測時間 2026-09-05T00:28:33.796045+00:00）。
...
| builder dex `xyz` | $755,203.15 | 3 | $1,563,728.55 |
| 現貨 spot | $4,460,324.99（含估算） | 3 幣 | — |
| **合計** | **$5,215,528.14** | **3** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,215,528.14 / $5,215,528.14）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,412,109.7228 | $4,412,109.72 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,460,319.30 | $0.00 |
| week | $4,460,319.30 | $0.00 |
| month | $4,460,319.30 | $32,229,551.72 |
| allTime | $4,460,319.30 | $349,809,663.11 |
| perpDay | $755,197.46 | $0.00 |
| perpWeek | $755,197.46 | $0.00 |
| perpMonth | $755,197.46 | $32,229,551.72 |
| perpAllTime | $755,197.46 | $341,755,306.05 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:NVDA | long | 5x | $944,076.57 | $44,319.75 |
| xyz | xyz:INTC | long | 1x | $545,129.38 | $45,190.03 |
| xyz | xyz:GOOGL | long | 10x | $74,522.60 | $-954.02 |
...
- 最後成交時間：**2026-08-26T21:08:20.358000+00:00**（距今 9.14 天）
...
- 非原生資金 $5,215,528.14 占總資產 $5,215,528.14 的100%（builder dex $755,203.15／現貨 $4,460,324.99）
