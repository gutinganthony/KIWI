...
> 純唯讀診斷（2026-09-17，探測時間 2026-09-17T00:58:21.516688+00:00）。
...
| builder dex `xyz` | $822,839.92 | 4 | $6,862,711.61 |
| 現貨 spot | $4,372,681.06（含估算） | 3 幣 | — |
| **合計** | **$5,195,520.98** | **4** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,195,520.98 / $5,195,520.98）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,324,465.796 | $4,324,465.80 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,372,650.68 | $0.00 |
| week | $4,372,650.68 | $0.00 |
| month | $4,372,650.68 | $29,012,640.13 |
| allTime | $4,372,650.68 | $356,969,101.81 |
| perpDay | $821,566.34 | $0.00 |
| perpWeek | $821,566.34 | $0.00 |
| perpMonth | $821,566.34 | $29,012,640.13 |
| perpAllTime | $821,566.34 | $348,914,744.75 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:SKHY | short | 10x | $2,883,893.65 | $329,377.25 |
| xyz | xyz:SKHX | long | 10x | $2,684,083.29 | $-333,954.95 |
| xyz | xyz:NVDA | long | 5x | $1,218,756.13 | $-40,973.13 |
| xyz | xyz:GOOGL | long | 10x | $75,978.53 | $501.91 |
...
- 最後成交時間：**2026-09-09T19:07:39.744000+00:00**（距今 7.24 天）
...
- 非原生資金 $5,195,520.98 占總資產 $5,195,520.98 的100%（builder dex $822,839.92／現貨 $4,372,681.06）
