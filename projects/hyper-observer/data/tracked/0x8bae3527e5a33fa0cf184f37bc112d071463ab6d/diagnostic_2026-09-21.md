...
> 純唯讀診斷（2026-09-21，探測時間 2026-09-21T00:35:40.952352+00:00）。
...
| builder dex `xyz` | $843,093.75 | 4 | $7,231,005.03 |
| 現貨 spot | $4,392,908.42（含估算） | 3 幣 | — |
| **合計** | **$5,236,002.17** | **4** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,236,002.17 / $5,236,002.17）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,344,693.1613 | $4,344,693.16 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,392,908.42 | $0.00 |
| week | $4,392,908.42 | $0.00 |
| month | $4,392,908.42 | $15,864,504.94 |
| allTime | $4,392,908.42 | $356,969,101.81 |
| perpDay | $841,793.70 | $0.00 |
| perpWeek | $841,793.70 | $0.00 |
| perpMonth | $841,793.70 | $15,864,504.94 |
| perpAllTime | $841,793.70 | $348,914,744.75 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:SKHY | short | 10x | $3,053,534.46 | $159,736.45 |
| xyz | xyz:SKHX | long | 10x | $2,840,284.17 | $-177,754.08 |
| xyz | xyz:NVDA | long | 5x | $1,259,952.09 | $222.83 |
| xyz | xyz:GOOGL | long | 10x | $77,234.32 | $1,757.69 |
...
- 最後成交時間：**2026-09-09T19:07:39.744000+00:00**（距今 11.23 天）
- 近 7 天成交：**0** 筆／近 30 天：**715** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 非原生資金 $5,236,002.17 占總資產 $5,236,002.17 的100%（builder dex $843,093.75／現貨 $4,392,908.42）
