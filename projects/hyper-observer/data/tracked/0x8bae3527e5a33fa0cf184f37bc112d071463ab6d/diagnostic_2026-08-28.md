...
> 純唯讀診斷（2026-08-28，探測時間 2026-08-28T06:26:22.982399+00:00）。
...
| builder dex `xyz` | $729,303.61 | 3 | $1,517,452.07 |
| 現貨 spot | $4,415,342.91（含估算） | 3 幣 | — |
| **合計** | **$5,144,646.52** | **3** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,144,646.52 / $5,144,646.52）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,367,127.6491 | $4,367,127.65 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,415,359.11 | $0.00 |
| week | $4,415,359.11 | $12,241,601.58 |
| month | $4,415,359.11 | $51,549,838.77 |
| allTime | $4,415,359.11 | $349,809,663.11 |
| perpDay | $729,345.63 | $0.00 |
| perpWeek | $729,345.63 | $12,241,601.58 |
| perpMonth | $729,345.63 | $51,549,838.77 |
| perpAllTime | $729,345.63 | $341,755,306.05 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:NVDA | long | 5x | $928,727.73 | $28,970.91 |
| xyz | xyz:INTC | long | 1x | $513,698.10 | $13,758.74 |
| xyz | xyz:GOOGL | long | 10x | $75,026.24 | $-450.38 |
...
- 最後成交時間：**2026-08-26T21:08:20.358000+00:00**（距今 1.39 天）
- 近 7 天成交：**402** 筆／近 30 天：**2000** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 非原生資金 $5,144,646.52 占總資產 $5,144,646.52 的100%（builder dex $729,303.61／現貨 $4,415,342.91）
