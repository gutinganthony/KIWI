...
> 純唯讀診斷（2026-09-16，探測時間 2026-09-16T00:54:18.351820+00:00）。
...
| builder dex `xyz` | $792,572.45 | 4 | $6,779,968.54 |
| 現貨 spot | $4,343,312.15（含估算） | 3 幣 | — |
| **合計** | **$5,135,884.60** | **4** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,135,884.60 / $5,135,884.60）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,295,096.8838 | $4,295,096.88 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,343,286.11 | $0.00 |
| week | $4,343,286.11 | $6,231,302.37 |
| month | $4,343,286.11 | $29,768,603.15 |
| allTime | $4,343,286.11 | $356,969,101.81 |
| perpDay | $792,197.42 | $0.00 |
| perpWeek | $792,197.42 | $6,231,302.37 |
| perpMonth | $792,197.42 | $29,768,603.15 |
| perpAllTime | $792,197.42 | $348,914,744.75 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:SKHY | short | 10x | $2,858,131.58 | $355,139.32 |
| xyz | xyz:SKHX | long | 10x | $2,645,718.17 | $-372,320.08 |
| xyz | xyz:NVDA | long | 5x | $1,200,333.80 | $-59,395.46 |
| xyz | xyz:GOOGL | long | 10x | $75,784.99 | $308.37 |
...
- 最後成交時間：**2026-09-09T19:07:39.744000+00:00**（距今 6.24 天）
- 近 7 天成交：**55** 筆／近 30 天：**836** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 非原生資金 $5,135,884.60 占總資產 $5,135,884.60 的100%（builder dex $792,572.45／現貨 $4,343,312.15）
