...
> 純唯讀診斷（2026-08-31，探測時間 2026-08-31T00:56:22.328227+00:00）。
...
| builder dex `xyz` | $685,370.53 | 3 | $1,473,684.95 |
| 現貨 spot | $4,370,843.73（含估算） | 3 幣 | — |
| **合計** | **$5,056,214.26** | **3** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,056,214.26 / $5,056,214.26）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,322,628.4638 | $4,322,628.46 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,370,838.91 | $0.00 |
| week | $4,370,838.91 | $5,250,038.86 |
| month | $4,370,838.91 | $34,927,251.78 |
| allTime | $4,370,838.91 | $349,809,663.11 |
| perpDay | $684,835.06 | $0.00 |
| perpWeek | $684,835.06 | $5,250,038.86 |
| perpMonth | $684,835.06 | $34,927,251.78 |
| perpAllTime | $684,835.06 | $341,755,306.05 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:NVDA | long | 5x | $895,157.28 | $-4,599.54 |
| xyz | xyz:INTC | long | 1x | $502,718.48 | $2,779.13 |
| xyz | xyz:GOOGL | long | 10x | $75,809.18 | $332.56 |
...
- 最後成交時間：**2026-08-26T21:08:20.358000+00:00**（距今 4.16 天）
- 近 7 天成交：**330** 筆／近 30 天：**1586** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 非原生資金 $5,056,214.26 占總資產 $5,056,214.26 的100%（builder dex $685,370.53／現貨 $4,370,843.73）
