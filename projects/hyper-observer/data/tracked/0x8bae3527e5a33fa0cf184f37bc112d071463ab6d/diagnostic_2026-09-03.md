...
> 純唯讀診斷（2026-09-03，探測時間 2026-09-03T01:23:19.508281+00:00）。
...
| builder dex `xyz` | $724,143.04 | 3 | $1,513,040.43 |
| 現貨 spot | $4,410,098.31（含估算） | 3 幣 | — |
| **合計** | **$5,134,241.35** | **3** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,134,241.35 / $5,134,241.35）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,361,883.0426 | $4,361,883.04 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,410,079.02 | $0.00 |
| week | $4,410,079.02 | $0.00 |
| month | $4,410,079.02 | $32,309,452.01 |
| allTime | $4,410,079.02 | $349,809,663.11 |
| perpDay | $724,089.64 | $0.00 |
| perpWeek | $724,089.64 | $0.00 |
| perpMonth | $724,089.64 | $32,309,452.01 |
| perpAllTime | $724,089.64 | $341,755,306.05 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:NVDA | long | 5x | $924,828.96 | $25,072.14 |
| xyz | xyz:INTC | long | 1x | $513,783.43 | $13,844.08 |
| xyz | xyz:GOOGL | long | 10x | $74,428.03 | $-1,048.59 |
...
- 最後成交時間：**2026-08-26T21:08:20.358000+00:00**（距今 7.18 天）
...
- 非原生資金 $5,134,241.35 占總資產 $5,134,241.35 的100%（builder dex $724,143.04／現貨 $4,410,098.31）
