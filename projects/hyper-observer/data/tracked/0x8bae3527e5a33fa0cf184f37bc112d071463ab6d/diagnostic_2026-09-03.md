...
> 純唯讀診斷（2026-09-03，探測時間 2026-09-03T00:46:58.826630+00:00）。
...
| builder dex `xyz` | $721,628.59 | 3 | $1,510,514.85 |
| 現貨 spot | $4,407,499.50（含估算） | 3 幣 | — |
| **合計** | **$5,129,128.09** | **3** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,129,128.09 / $5,129,128.09）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,359,284.2359 | $4,359,284.24 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,407,477.80 | $0.00 |
| week | $4,407,477.80 | $0.00 |
| month | $4,407,477.80 | $32,309,452.01 |
| allTime | $4,407,477.80 | $349,809,663.11 |
| perpDay | $721,490.84 | $0.00 |
| perpWeek | $721,490.84 | $0.00 |
| perpMonth | $721,490.84 | $32,309,452.01 |
| perpAllTime | $721,490.84 | $341,755,306.05 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:NVDA | long | 5x | $923,885.05 | $24,128.23 |
| xyz | xyz:INTC | long | 1x | $512,230.36 | $12,291.00 |
| xyz | xyz:GOOGL | long | 10x | $74,399.44 | $-1,077.18 |
...
- 最後成交時間：**2026-08-26T21:08:20.358000+00:00**（距今 7.15 天）
- 近 7 天成交：**0** 筆／近 30 天：**856** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 非原生資金 $5,129,128.09 占總資產 $5,129,128.09 的100%（builder dex $721,628.59／現貨 $4,407,499.50）
