...
> 純唯讀診斷（2026-08-30，探測時間 2026-08-30T00:48:52.478128+00:00）。
...
| builder dex `xyz` | $698,445.47 | 3 | $1,486,989.43 |
| 現貨 spot | $4,384,454.13（含估算） | 3 幣 | — |
| **合計** | **$5,082,899.60** | **3** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,082,899.60 / $5,082,899.60）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,336,238.8662 | $4,336,238.87 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,384,458.95 | $0.00 |
| week | $4,384,458.95 | $5,274,893.45 |
| month | $4,384,458.95 | $44,427,966.28 |
| allTime | $4,384,458.95 | $349,809,663.11 |
| perpDay | $698,445.47 | $0.00 |
| perpWeek | $698,445.47 | $5,274,893.45 |
| perpMonth | $698,445.47 | $44,427,966.28 |
| perpAllTime | $698,445.47 | $341,755,306.05 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:NVDA | long | 5x | $897,701.74 | $-2,055.08 |
| xyz | xyz:INTC | long | 1x | $513,117.83 | $13,178.47 |
| xyz | xyz:GOOGL | long | 10x | $76,169.86 | $693.24 |
...
- 最後成交時間：**2026-08-26T21:08:20.358000+00:00**（距今 3.15 天）
- 近 7 天成交：**352** 筆／近 30 天：**2000** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 非原生資金 $5,082,899.60 占總資產 $5,082,899.60 的100%（builder dex $698,445.47／現貨 $4,384,454.13）
