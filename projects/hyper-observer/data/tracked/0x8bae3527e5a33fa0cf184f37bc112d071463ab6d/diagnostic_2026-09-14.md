...
> 純唯讀診斷（2026-09-14，探測時間 2026-09-14T00:33:01.534222+00:00）。
...
| builder dex `xyz` | $793,661.65 | 4 | $6,926,834.46 |
| 現貨 spot | $4,344,657.58（含估算） | 3 幣 | — |
| **合計** | **$5,138,319.23** | **4** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,138,319.23 / $5,138,319.23）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,296,442.319 | $4,296,442.32 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,345,012.65 | $0.00 |
| week | $4,345,012.65 | $7,159,438.70 |
| month | $4,345,012.65 | $29,768,603.15 |
| allTime | $4,345,012.65 | $356,969,101.81 |
| perpDay | $793,910.46 | $0.00 |
| perpWeek | $793,910.46 | $7,159,438.70 |
| perpMonth | $793,910.46 | $29,768,603.15 |
| perpAllTime | $793,910.46 | $348,914,744.75 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:SKHY | short | 10x | $2,935,255.77 | $278,015.14 |
| xyz | xyz:SKHX | long | 10x | $2,705,584.63 | $-312,453.62 |
| xyz | xyz:NVDA | long | 5x | $1,212,144.43 | $-47,584.83 |
| xyz | xyz:GOOGL | long | 10x | $73,849.62 | $-1,627.00 |
...
- 最後成交時間：**2026-09-09T19:07:39.744000+00:00**（距今 4.23 天）
- 近 7 天成交：**323** 筆／近 30 天：**836** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 非原生資金 $5,138,319.23 占總資產 $5,138,319.23 的100%（builder dex $793,661.65／現貨 $4,344,657.58）
