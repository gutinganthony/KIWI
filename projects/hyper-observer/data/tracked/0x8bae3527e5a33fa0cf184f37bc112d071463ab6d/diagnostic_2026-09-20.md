...
> 純唯讀診斷（2026-09-20，探測時間 2026-09-20T00:29:34.472989+00:00）。
...
| builder dex `xyz` | $852,360.37 | 4 | $7,183,284.92 |
| 現貨 spot | $4,403,637.12（含估算） | 3 幣 | — |
| **合計** | **$5,255,997.49** | **4** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,255,997.49 / $5,255,997.49）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,355,421.8559 | $4,355,421.86 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,403,633.26 | $0.00 |
| week | $4,403,633.26 | $0.00 |
| month | $4,403,633.26 | $29,012,640.13 |
| allTime | $4,403,633.26 | $356,969,101.81 |
| perpDay | $852,522.40 | $0.00 |
| perpWeek | $852,522.40 | $0.00 |
| perpMonth | $852,522.40 | $29,012,640.13 |
| perpAllTime | $852,522.40 | $348,914,744.75 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:SKHY | short | 10x | $3,025,017.95 | $188,252.96 |
| xyz | xyz:SKHX | long | 10x | $2,826,160.74 | $-191,877.50 |
| xyz | xyz:NVDA | long | 5x | $1,254,753.15 | $-4,976.11 |
| xyz | xyz:GOOGL | long | 10x | $77,353.08 | $1,876.46 |
...
- 最後成交時間：**2026-09-09T19:07:39.744000+00:00**（距今 10.22 天）
- 近 7 天成交：**0** 筆／近 30 天：**775** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 非原生資金 $5,255,997.49 占總資產 $5,255,997.49 的100%（builder dex $852,360.37／現貨 $4,403,637.12）
