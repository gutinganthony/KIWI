...
> 純唯讀診斷（2026-08-27，探測時間 2026-08-27T03:39:29.710154+00:00）。
...
| builder dex `xyz` | $705,672.33 | 3 | $1,493,476.43 |
| 現貨 spot | $4,391,679.70（含估算） | 3 幣 | — |
| **合計** | **$5,097,352.03** | **3** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,097,352.03 / $5,097,352.03）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,343,464.4392 | $4,343,464.44 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,391,673.43 | $2,915,227.75 |
| week | $4,391,673.43 | $21,853,201.43 |
| month | $4,391,673.43 | $51,549,886.37 |
| allTime | $4,391,673.43 | $349,809,663.11 |
| perpDay | $705,671.04 | $2,915,227.75 |
| perpWeek | $705,671.04 | $21,853,201.43 |
| perpMonth | $705,671.04 | $51,549,886.37 |
| perpAllTime | $705,671.04 | $341,755,306.05 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:NVDA | long | 5x | $908,166.86 | $8,410.04 |
| xyz | xyz:INTC | long | 1x | $510,045.81 | $10,106.46 |
| xyz | xyz:GOOGL | long | 10x | $75,263.76 | $-212.86 |
...
- 最後成交時間：**2026-08-26T21:08:20.358000+00:00**（距今 0.27 天）
- 近 7 天成交：**452** 筆／近 30 天：**2000** 筆（回應共 2000 筆，已達 API 截斷上限）
...
- 非原生資金 $5,097,352.03 占總資產 $5,097,352.03 的100%（builder dex $705,672.33／現貨 $4,391,679.70）
- 成交戰場分布：非原生 1820/2000 筆（91%）
- 近 45 天帳變動離場訊號：跨層轉移（HyperCore→HyperEVM，同一擁有者） $2,130,000.00
- 跨層轉移（HyperCore→HyperEVM，同一地址擁有者，非第三方）$2,130,000.00，占「現餘＋跨層轉移」29%（≥ 20% 門檻）→ 資本正離開交易場（跨層/減倉）
