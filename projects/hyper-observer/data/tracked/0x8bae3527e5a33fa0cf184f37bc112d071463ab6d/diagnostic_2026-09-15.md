...
> 純唯讀診斷（2026-09-15，探測時間 2026-09-15T01:00:22.926731+00:00）。
...
| builder dex `xyz` | $788,823.43 | 4 | $6,825,038.42 |
| 現貨 spot | $4,340,045.87（含估算） | 3 幣 | — |
| **合計** | **$5,128,869.30** | **4** | — |

非原生（builder dex＋現貨）占比：**100.0%**（$5,128,869.30 / $5,128,869.30）

現貨非零餘額（估值：USDC 類 1:1；其他 token 用 entryNtl 成本基礎粗估）：

| 幣 | 數量 | USD |
|---|---:|---:|
| USDC | 4,291,830.6058 | $4,291,830.61 |
...
| 視窗 | accountValue | vlm |
|---|---:|---:|
| day | $4,340,643.00 | $0.00 |
| week | $4,340,643.00 | $7,159,438.70 |
| month | $4,340,643.00 | $29,768,603.15 |
| allTime | $4,340,643.00 | $356,969,101.81 |
| perpDay | $789,528.28 | $0.00 |
| perpWeek | $789,528.28 | $7,159,438.70 |
| perpMonth | $789,528.28 | $29,768,603.15 |
| perpAllTime | $789,528.28 | $348,914,744.75 |
...
|---|---|---|---:|---:|---:|
| xyz | xyz:SKHY | short | 10x | $2,883,731.63 | $329,539.28 |
| xyz | xyz:SKHX | long | 10x | $2,664,268.34 | $-353,769.91 |
| xyz | xyz:NVDA | long | 5x | $1,200,672.86 | $-59,056.40 |
| xyz | xyz:GOOGL | long | 10x | $76,365.60 | $888.98 |
...
- 最後成交時間：**2026-09-09T19:07:39.744000+00:00**（距今 5.24 天）
...
- 非原生資金 $5,128,869.30 占總資產 $5,128,869.30 的100%（builder dex $788,823.43／現貨 $4,340,045.87）
