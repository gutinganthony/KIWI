# Hyperliquid 廣域可跟錢包掃描 — 2026-09-14
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,233,430 | 6% | 11.79 | 10x | xyz:DRAM | 424 | ✅（30d 事件 24／fills 836）|
| `0xa237f4cc7bbc930fd531b1a36f31e54f778fc431` | $161,745 | 25% | 1.78 | 5x | CASHCAT | 802 | ❌ 持倉過短：平均 10.6h < 12h（30d 事件 25（截斷外推 61）／fills 2,000）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $32,012 | 0% | 1.43 | —x | @107 | 865 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
