# Hyperliquid 廣域可跟錢包掃描 — 2026-09-21
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,282,149 | 6% | 11.79 | 10x | xyz:DRAM | 431 | ✅（30d 事件 12／fills 675）|
| `0x016e7005d7648b3aabb8023f02601b8b9b8746b0` | $4,065,446 | 29% | — | 2x | LIT | 78 | ❌ 平均持倉時間估不出（無 Open/Close 成交可配對），保守判不可跟（30d 事件 0／fills 0）|
| `0x230963164d9637a4c536270a06b4e3636d44a2d9` | $2,286,725 | 31% | 2.45 | 20x | ZEC | 487 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 8／fills 621）|
| `0x3e9b6020cb47785b9416e83fad561a72d2af4de8` | $917,582 | 5% | 5.08 | —x | @107 | 655 | ✅（30d 事件 1／fills 67）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $32,022 | 0% | 1.43 | —x | @107 | 872 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
