# Hyperliquid 廣域可跟錢包掃描 — 2026-09-12
...
| `portfolio @ api.hyperliquid.xyz/info` | 38 | 1 | status=429 HTTP 429; body=null |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,283,753 | 6% | 11.79 | 10x | xyz:DRAM | 422 | ✅（30d 事件 24／fills 836）|
| `0xa237f4cc7bbc930fd531b1a36f31e54f778fc431` | $159,446 | 25% | 2.01 | 5x | CASHCAT | 800 | ❌ 持倉過短：平均 10.7h < 12h（30d 事件 24（截斷外推 69）／fills 2,000）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $32,012 | 0% | 1.43 | —x | @107 | 863 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
