# Hyperliquid 廣域可跟錢包掃描 — 2026-08-28
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,302,089 | 6% | 11.15 | 10x | xyz:META | 407 | ✅（30d 事件 40（截斷外推 42）／fills 2,000）|
| `0x3e9b6020cb47785b9416e83fad561a72d2af4de8` | $917,582 | 5% | 4.95 | —x | @107 | 631 | ✅（30d 事件 0／fills 0）|
| `0xbd34523189edc7a9e9c202a15e00afe18ba4bc7f` | $93,024 | 10% | 4.23 | 3x | @107 | 208 | ✅（30d 事件 14／fills 1,036）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $31,947 | 0% | 1.43 | —x | @107 | 848 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
