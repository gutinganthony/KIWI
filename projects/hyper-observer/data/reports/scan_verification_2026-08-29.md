# Hyperliquid 廣域可跟錢包掃描 — 2026-08-29
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,265,240 | 6% | 11.15 | 10x | xyz:META | 408 | ✅（30d 事件 40／fills 2,000）|
| `0xd2a238110d411970efdc9cccfb4110a6fe24206e` | $1,633,535 | 0% | 379.45 | —x | @151 | 520 | ✅（30d 事件 0／fills 0）|
| `0x3e9b6020cb47785b9416e83fad561a72d2af4de8` | $917,582 | 5% | 4.95 | —x | @107 | 632 | ✅（30d 事件 0／fills 0）|
| `0xbd34523189edc7a9e9c202a15e00afe18ba4bc7f` | $67,541 | 31% | 4.23 | 3x | @107 | 209 | ✅（30d 事件 14／fills 1,036）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $31,949 | 0% | 1.43 | —x | @107 | 849 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
...
其中 followable（可跟）數量：**4**

**consistent_winner 5 個，其中 followable 4 個（僅少數可跟候選，證據不足，需持續觀察）**
