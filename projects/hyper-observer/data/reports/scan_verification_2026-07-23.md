# Hyperliquid 廣域可跟錢包掃描 — 2026-07-23
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x99b1098d9d50aa076f78bd26ab22e6abd3710729` | $26,455,470 | 40% | 6.49 | 10x | xyz:SKHX | 316 | ❌ 頻率過高：30 日推估 260 個部位事件 > 150（fills 截斷窗覆蓋 6.3 天、實測 55 個外推；fills 2000 筆僅參考）；持倉過短：平均 9.0h < 12h（30d 事件 55（截斷外推 260）／fills 2,000）|
| `0x06cecfbac34101ae41c88ebc2450f8602b3d164b` | $14,275,571 | 28% | 0.91 | 20x | @107 | 680 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 20／fills 1,389）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $9,643,399 | 6% | 2.15 | —x | xyz:SNDK | 372 | ✅（30d 事件 38（截斷外推 118）／fills 2,000）|
| `0xbe19541903f64af97bcf8436f4d15bf3a56b8bd1`（⚠️ 曾強平 2 次） | $9,226,843 | 17% | 370.50 | 10x | WLD | 358 | ❌ 平均持倉時間估不出（無 Open/Close 成交可配對），保守判不可跟（30d 事件 4（截斷外推 10）／fills 2,000）|
| `0xbe494a5e3a719a78a45a47ab453b7b0199b9d101` | $2,918,792 | 34% | 0.17 | 20x | HYPE | 309 | ❌ 持倉過短：平均 0.2h < 12h；槓桿過高：目前 20x > 10x（30d 事件 28（截斷外推 58）／fills 2,000）|
