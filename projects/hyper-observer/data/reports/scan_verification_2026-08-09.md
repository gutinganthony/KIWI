# Hyperliquid 廣域可跟錢包掃描 — 2026-08-09
...
| 端點 | 成功 | 失敗 | 失敗樣本 |
|---|---:|---:|---|
| `clearinghouseState @ api.hyperliquid.xyz/info` | 25 | 0 | — |
...
| `portfolio @ api.hyperliquid.xyz/info` | 25 | 0 | — |
| `spotClearinghouseState @ api.hyperliquid.xyz/info` | 3 | 0 | — |
| `userFills @ api.hyperliquid.xyz/info` | 25 | 0 | — |
| `userFunding @ api.hyperliquid.xyz/info` | 24 | 1 | status=429 HTTP 429; body=null |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $9,988,539 | 6% | 2.66 | 20x | xyz:SKHX | 389 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 25（截斷外推 70）／fills 2,000）|
