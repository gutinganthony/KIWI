# Hyperliquid 廣域可跟錢包掃描 — 2026-08-12
...
| 端點 | 成功 | 失敗 | 失敗樣本 |
|---|---:|---:|---|
| `clearinghouseState @ api.hyperliquid.xyz/info` | 27 | 0 | — |
...
| `portfolio @ api.hyperliquid.xyz/info` | 27 | 0 | — |
| `spotClearinghouseState @ api.hyperliquid.xyz/info` | 3 | 0 | — |
| `userFills @ api.hyperliquid.xyz/info` | 27 | 0 | — |
| `userFunding @ api.hyperliquid.xyz/info` | 27 | 0 | — |

## 2. 分類統計

| 分類 | 錢包數 | 佔比 |
|---|---:|---:|
| consistent_winner | 4 | 15% |
| blowup_risk | 13 | 48% |
| wash_suspect | 0 | 0% |
| one_hit | 2 | 7% |
| dormant | 0 | 0% |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x99b1098d9d50aa076f78bd26ab22e6abd3710729` | $26,458,549 | 40% | 0.08 | —x | xyz:GIGADEV | 336 | ❌ 持倉過短：平均 1.3h < 12h（30d 事件 26（截斷外推 88）／fills 2,000）|
| `0x06cecfbac34101ae41c88ebc2450f8602b3d164b` | $14,406,494 | 27% | 0.02 | 20x | @107 | 700 | ❌ 持倉過短：平均 1.1h < 12h；槓桿過高：目前 20x > 10x（30d 事件 16（截斷外推 18）／fills 2,000）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $10,030,608 | 6% | 2.73 | 10x | xyz:GOOGL | 392 | ✅（30d 事件 26（截斷外推 59）／fills 2,000）|
| `0xbe494a5e3a719a78a45a47ab453b7b0199b9d101` | $2,921,685 | 34% | 0.85 | 20x | HYPE | 329 | ❌ 持倉過短：平均 6.0h < 12h；槓桿過高：目前 20x > 10x（30d 事件 50／fills 781）|
