# Hyperliquid 廣域可跟錢包掃描 — 2026-08-01
...
| 端點 | 成功 | 失敗 | 失敗樣本 |
|---|---:|---:|---|
| `clearinghouseState @ api.hyperliquid.xyz/info` | 43 | 0 | — |
...
| `portfolio @ api.hyperliquid.xyz/info` | 43 | 0 | — |
| `spotClearinghouseState @ api.hyperliquid.xyz/info` | 3 | 0 | — |
| `userFills @ api.hyperliquid.xyz/info` | 43 | 0 | — |
| `userFunding @ api.hyperliquid.xyz/info` | 42 | 1 | status=429 HTTP 429; body=null |

## 2. 分類統計

| 分類 | 錢包數 | 佔比 |
|---|---:|---:|
| consistent_winner | 5 | 12% |
| blowup_risk | 20 | 47% |
| wash_suspect | 1 | 2% |
| one_hit | 7 | 16% |
| dormant | 0 | 0% |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x99b1098d9d50aa076f78bd26ab22e6abd3710729` | $26,462,926 | 40% | 3.09 | 10x | xyz:SKHX | 325 | ❌ 頻率過高：30 日推估 258 個部位事件 > 150（fills 截斷窗覆蓋 13.0 天、實測 112 個外推；fills 2000 筆僅參考）；持倉過短：平均 6.3h < 12h（30d 事件 112（截斷外推 258）／fills 2,000）|
| `0x06cecfbac34101ae41c88ebc2450f8602b3d164b` | $15,145,740 | 28% | 0.02 | 20x | @107 | 689 | ❌ 持倉過短：平均 1.1h < 12h；槓桿過高：目前 20x > 10x（30d 事件 16（截斷外推 31）／fills 2,000）|
| `0xbe19541903f64af97bcf8436f4d15bf3a56b8bd1`（⚠️ 曾強平 2 次） | $10,126,218 | 17% | 781.81 | 10x | WLD | 367 | ✅（30d 事件 5（截斷外推 7）／fills 2,000）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d`（⚠️ 曾強平 1 次） | $9,855,165 | 6% | 1.98 | 20x | xyz:META | 381 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 27（截斷外推 83）／fills 2,000）|
| `0xbe494a5e3a719a78a45a47ab453b7b0199b9d101` | $2,926,811 | 34% | 0.69 | 20x | HYPE | 318 | ❌ 持倉過短：平均 0.1h < 12h；槓桿過高：目前 20x > 10x（30d 事件 48（截斷外推 61）／fills 2,000）|
