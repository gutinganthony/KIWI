# Hyperliquid 廣域可跟錢包掃描 — 2026-07-12
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8e096995c3e4a3f0bc5b3ea1cba94de2aa4d70c9` | $59,354,752 | 35% | 453,866.15 | 20x | xyz:SKHX | 578 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 8（截斷外推 25）／fills 2,000）|
| `0x84abc08c0ea62e687c370154de1f38ea462f4d37` | $9,968,650 | 21% | 6.11 | —x | xyz:DRAM | 354 | ❌ 平均持倉時間估不出（無 Open/Close 成交可配對），保守判不可跟（30d 事件 8（截斷外推 87）／fills 2,000）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $9,608,661 | 6% | 16.71 | 3x | @166 | 361 | ✅（30d 事件 39／fills 1,024）|
