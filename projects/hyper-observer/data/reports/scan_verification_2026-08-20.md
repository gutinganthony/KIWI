# Hyperliquid 廣域可跟錢包掃描 — 2026-08-20
...
| `portfolio @ api.hyperliquid.xyz/info` | 120 | 3 | status=429 HTTP 429; body=null |
| `spotClearinghouseState @ api.hyperliquid.xyz/info` | 3 | 0 | — |
| `userFills @ api.hyperliquid.xyz/info` | 123 | 0 | — |
| `userFunding @ api.hyperliquid.xyz/info` | 121 | 2 | status=429 HTTP 429; body=null |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $10,277,574 | 6% | 2.73 | 10x | xyz:GOOGL | 400 | ✅（30d 事件 27（截斷外推 39）／fills 2,000）|
| `0xd2a238110d411970efdc9cccfb4110a6fe24206e` | $1,633,535 | 0% | 379.45 | —x | @151 | 512 | ✅（30d 事件 0／fills 0）|
| `0x3e9b6020cb47785b9416e83fad561a72d2af4de8` | $917,582 | 5% | 4.95 | —x | @107 | 624 | ✅（30d 事件 0／fills 0）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $31,866 | 0% | 1.43 | —x | @107 | 841 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
