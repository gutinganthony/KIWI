# Hyperliquid 廣域可跟錢包掃描 — 2026-09-11
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,260,177 | 6% | 11.79 | 10x | xyz:DRAM | 421 | ✅（30d 事件 25／fills 915）|
| `0x3e9b6020cb47785b9416e83fad561a72d2af4de8` | $917,582 | 5% | 5.08 | —x | @107 | 645 | ✅（30d 事件 1／fills 67）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $32,012 | 0% | 1.43 | —x | @107 | 862 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
