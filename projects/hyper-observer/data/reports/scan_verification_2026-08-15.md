# Hyperliquid 廣域可跟錢包掃描 — 2026-08-15
...
| `userFunding @ api.hyperliquid.xyz/info` | 40 | 1 | status=429 HTTP 429; body=null |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x99b1098d9d50aa076f78bd26ab22e6abd3710729` | $26,458,549 | 40% | 0.15 | —x | xyz:GIGADEV | 339 | ❌ 持倉過短：平均 1.3h < 12h（30d 事件 27（截斷外推 68）／fills 2,000）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $10,005,697 | 6% | 2.73 | 10x | xyz:GOOGL | 395 | ✅（30d 事件 26（截斷外推 49）／fills 2,000）|
