# Hyperliquid 廣域可跟錢包掃描 — 2026-08-11
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x06cecfbac34101ae41c88ebc2450f8602b3d164b` | $14,608,541 | 27% | 0.02 | 20x | @107 | 699 | ❌ 持倉過短：平均 1.1h < 12h；槓桿過高：目前 20x > 10x（30d 事件 16（截斷外推 19）／fills 2,000）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $9,979,847 | 6% | 2.66 | 20x | xyz:SKHX | 391 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 25（截斷外推 59）／fills 2,000）|
| `0xbe494a5e3a719a78a45a47ab453b7b0199b9d101` | $2,923,727 | 34% | 0.58 | 20x | HYPE | 328 | ❌ 持倉過短：平均 0.1h < 12h；槓桿過高：目前 20x > 10x（30d 事件 50／fills 781）|
