# Hyperliquid 廣域可跟錢包掃描 — 2026-07-27
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x99b1098d9d50aa076f78bd26ab22e6abd3710729` | $26,458,418 | 40% | 6.01 | 10x | xyz:SKHX | 320 | ❌ 頻率過高：30 日推估 266 個部位事件 > 150（fills 截斷窗覆蓋 9.4 天、實測 83 個外推；fills 2000 筆僅參考）；持倉過短：平均 7.8h < 12h（30d 事件 83（截斷外推 266）／fills 2,000）|
| `0x06cecfbac34101ae41c88ebc2450f8602b3d164b` | $14,856,459 | 28% | 0.91 | 20x | @107 | 684 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 18／fills 1,381）|
| `0xbe19541903f64af97bcf8436f4d15bf3a56b8bd1`（⚠️ 曾強平 2 次） | $9,839,397 | 17% | 370.50 | 10x | WLD | 362 | ❌ 平均持倉時間估不出（無 Open/Close 成交可配對），保守判不可跟（30d 事件 4（截斷外推 8）／fills 2,000）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $9,709,209 | 6% | 1.45 | 3x | xyz:SNDK | 376 | ✅（30d 事件 40（截斷外推 92）／fills 2,000）|
| `0xbe494a5e3a719a78a45a47ab453b7b0199b9d101` | $2,921,592 | 34% | 0.26 | 20x | HYPE | 313 | ❌ 持倉過短：平均 0.1h < 12h；槓桿過高：目前 20x > 10x（30d 事件 40（截斷外推 65）／fills 2,000）|
