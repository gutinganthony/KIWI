# Hyperliquid 廣域可跟錢包掃描 — 2026-08-03
...
| `userFills @ api.hyperliquid.xyz/info` | 42 | 1 | status=429 HTTP 429; body=null |
| `userFunding @ api.hyperliquid.xyz/info` | 43 | 0 | — |

## 2. 分類統計

| 分類 | 錢包數 | 佔比 |
|---|---:|---:|
| consistent_winner | 4 | 9% |
| blowup_risk | 20 | 47% |
| wash_suspect | 2 | 5% |
| one_hit | 5 | 12% |
| dormant | 0 | 0% |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x06cecfbac34101ae41c88ebc2450f8602b3d164b` | $14,803,768 | 28% | 0.02 | 20x | @107 | 691 | ❌ 持倉過短：平均 1.1h < 12h；槓桿過高：目前 20x > 10x（30d 事件 16（截斷外推 28）／fills 2,000）|
| `0xbe19541903f64af97bcf8436f4d15bf3a56b8bd1`（⚠️ 曾強平 2 次） | $9,931,592 | 17% | 1,759.74 | 10x | MEGA | 369 | ✅（30d 事件 6（截斷外推 8）／fills 2,000）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $9,874,707 | 6% | 0.82 | 20x | xyz:SKHX | 383 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 20（截斷外推 129）／fills 2,000）|
| `0xbe494a5e3a719a78a45a47ab453b7b0199b9d101` | $2,924,357 | 34% | 0.69 | 20x | HYPE | 320 | ❌ 持倉過短：平均 0.1h < 12h；槓桿過高：目前 20x > 10x（30d 事件 48（截斷外推 56）／fills 2,000）|
...
**consistent_winner 4 個，其中 followable 1 個（僅少數可跟候選，證據不足，需持續觀察）**
