# Hyperliquid 廣域可跟錢包掃描 — 2026-07-17
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x99b1098d9d50aa076f78bd26ab22e6abd3710729` | $26,449,749 | 40% | 43.16 | 10x | xyz:SKHX | 310 | ❌ 頻率過高：30 日推估 303 個部位事件 > 150（fills 截斷窗覆蓋 4.0 天、實測 40 個外推；fills 2000 筆僅參考）（30d 事件 40（截斷外推 303）／fills 2,000）|
| `0x06cecfbac34101ae41c88ebc2450f8602b3d164b` | $14,494,257 | 28% | 0.88 | 20x | @107 | 674 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 20／fills 1,471）|
| `0x84abc08c0ea62e687c370154de1f38ea462f4d37` | $13,070,275 | 22% | — | —x | xyz:DRAM | 359 | ❌ 頻率過高：30 日推估 280 個部位事件 > 150（fills 截斷窗覆蓋 0.3 天、實測 3 個外推；fills 2000 筆僅參考）；平均持倉時間估不出（無 Open/Close 成交可配對），保守判不可跟（30d 事件 3（截斷外推 280）／fills 2,000）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $9,623,558 | 6% | 15.78 | —x | @166 | 366 | ✅（30d 事件 53（截斷外推 77）／fills 2,000）|
| `0xbe19541903f64af97bcf8436f4d15bf3a56b8bd1`（⚠️ 曾強平 1 次） | $9,171,053 | 17% | — | 20x | WLD | 352 | ❌ 平均持倉時間估不出（無 Open/Close 成交可配對），保守判不可跟；槓桿過高：目前 20x > 10x（30d 事件 3（截斷外推 14）／fills 2,000）|
| `0xbe494a5e3a719a78a45a47ab453b7b0199b9d101` | $2,916,352 | 34% | 0.54 | 20x | HYPE | 303 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 28（截斷外推 77）／fills 2,000）|
