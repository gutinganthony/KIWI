# Hyperliquid 廣域可跟錢包掃描 — 2026-09-02
...
| 端點 | 成功 | 失敗 | 失敗樣本 |
|---|---:|---:|---|
| `clearinghouseState @ api.hyperliquid.xyz/info` | 121 | 2 | status=429 HTTP 429; body=null |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,257,998 | 6% | 11.15 | 10x | xyz:META | 412 | ✅（30d 事件 29／fills 856）|
| `0xbd34523189edc7a9e9c202a15e00afe18ba4bc7f` | $81,882 | 31% | 4.23 | 3x | @107 | 213 | ✅（30d 事件 14／fills 1,036）|
...
**consistent_winner 2 個，其中 followable 2 個（僅少數可跟候選，證據不足，需持續觀察）**
