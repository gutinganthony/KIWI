# Hyperliquid 廣域可跟錢包掃描 — 2026-09-01
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,271,798 | 6% | 11.15 | 10x | xyz:META | 411 | ✅（30d 事件 29／fills 856）|
| `0xd2a238110d411970efdc9cccfb4110a6fe24206e` | $1,633,535 | 0% | 379.45 | —x | @151 | 523 | ✅（30d 事件 0／fills 0）|
| `0xbd34523189edc7a9e9c202a15e00afe18ba4bc7f` | $103,006 | 31% | 4.23 | 3x | @107 | 212 | ✅（30d 事件 14／fills 1,036）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $31,949 | 0% | 1.43 | —x | @107 | 852 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
