# Hyperliquid 廣域可跟錢包掃描 — 2026-08-30
...
| 端點 | 成功 | 失敗 | 失敗樣本 |
|---|---:|---:|---|
| `clearinghouseState @ api.hyperliquid.xyz/info` | 122 | 1 | status=429 HTTP 429; body=null |
...
| `userFunding @ api.hyperliquid.xyz/info` | 122 | 1 | status=429 HTTP 429; body=null |

## 2. 分類統計

| 分類 | 錢包數 | 佔比 |
|---|---:|---:|
| consistent_winner | 4 | 3% |
| blowup_risk | 63 | 51% |
| wash_suspect | 12 | 10% |
| one_hit | 19 | 15% |
| dormant | 0 | 0% |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,270,752 | 6% | 11.15 | 10x | xyz:META | 409 | ✅（30d 事件 36／fills 1,586）|
| `0x3e9b6020cb47785b9416e83fad561a72d2af4de8` | $917,582 | 5% | 4.95 | —x | @107 | 633 | ✅（30d 事件 0／fills 0）|
| `0xbd34523189edc7a9e9c202a15e00afe18ba4bc7f` | $92,195 | 31% | 4.23 | 3x | @107 | 210 | ✅（30d 事件 14／fills 1,036）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $31,949 | 0% | 1.43 | —x | @107 | 850 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
...
**consistent_winner 4 個，其中 followable 3 個（僅少數可跟候選，證據不足，需持續觀察）**
