# Hyperliquid 廣域可跟錢包掃描 — 2026-09-22
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x016e7005d7648b3aabb8023f02601b8b9b8746b0` | $3,726,150 | 29% | — | 2x | LIT | 78 | ❌ 平均持倉時間估不出（無 Open/Close 成交可配對），保守判不可跟（30d 事件 0／fills 0）|
| `0x230963164d9637a4c536270a06b4e3636d44a2d9` | $2,199,487 | 31% | 2.45 | 20x | ZEC | 488 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 8／fills 621）|
| `0x3e9b6020cb47785b9416e83fad561a72d2af4de8` | $917,582 | 5% | 5.08 | —x | @107 | 656 | ✅（30d 事件 1／fills 67）|
