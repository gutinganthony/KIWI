# Hyperliquid 廣域可跟錢包掃描 — 2026-08-04
...
|---|---:|---:|---:|---:|---|---:|---|
| `0xbe19541903f64af97bcf8436f4d15bf3a56b8bd1`（⚠️ 曾強平 2 次） | $9,964,191 | 17% | 1,759.74 | 10x | MEGA | 370 | ✅（30d 事件 6（截斷外推 8）／fills 2,000）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $9,931,112 | 6% | 0.82 | 20x | xyz:SKHX | 384 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 21（截斷外推 112）／fills 2,000）|
