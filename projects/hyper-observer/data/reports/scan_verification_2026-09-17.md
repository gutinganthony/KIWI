# Hyperliquid 廣域可跟錢包掃描 — 2026-09-17
...
| 端點 | 成功 | 失敗 | 失敗樣本 |
|---|---:|---:|---|
| `clearinghouseState @ api.hyperliquid.xyz/info` | 41 | 0 | — |
...
| `portfolio @ api.hyperliquid.xyz/info` | 41 | 0 | — |
| `spotClearinghouseState @ api.hyperliquid.xyz/info` | 3 | 0 | — |
| `userFills @ api.hyperliquid.xyz/info` | 41 | 0 | — |
| `userFunding @ api.hyperliquid.xyz/info` | 41 | 0 | — |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,259,733 | 6% | 11.79 | 10x | xyz:DRAM | 427 | ✅（30d 事件 23／fills 775）|
| `0x016e7005d7648b3aabb8023f02601b8b9b8746b0` | $3,842,108 | 34% | — | 2x | LIT | 74 | ❌ 平均持倉時間估不出（無 Open/Close 成交可配對），保守判不可跟（30d 事件 0／fills 0）|
| `0x230963164d9637a4c536270a06b4e3636d44a2d9` | $1,976,739 | 31% | 4.74 | 20x | ZEC | 483 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 3／fills 181）|
| `0x3e9b6020cb47785b9416e83fad561a72d2af4de8` | $917,582 | 5% | 5.08 | —x | @107 | 651 | ✅（30d 事件 1／fills 67）|
| `0xa237f4cc7bbc930fd531b1a36f31e54f778fc431` | $145,402 | 25% | 1.48 | —x | CASHCAT | 805 | ❌ 持倉過短：平均 12.0h < 12h（30d 事件 26（截斷外推 52）／fills 2,000）|
...
**consistent_winner 5 個，其中 followable 2 個（僅少數可跟候選，證據不足，需持續觀察）**
