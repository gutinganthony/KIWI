# Hyperliquid 廣域可跟錢包掃描 — 2026-09-19
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,294,502 | 6% | 11.79 | 10x | xyz:DRAM | 429 | ✅（30d 事件 23／fills 775）|
| `0x230963164d9637a4c536270a06b4e3636d44a2d9` | $2,303,593 | 31% | 2.45 | 20x | ZEC | 485 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 6／fills 329）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $32,013 | 0% | 1.43 | —x | @107 | 870 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
