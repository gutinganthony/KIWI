# Hyperliquid 廣域可跟錢包掃描 — 2026-07-14
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x99b1098d9d50aa076f78bd26ab22e6abd3710729` | $26,443,843 | 40% | 177.32 | 10x | xyz:SKHX | 307 | ❌ 頻率過高：30 日推估 665 個部位事件 > 150（fills 截斷窗覆蓋 1.8 天、實測 41 個外推；fills 2000 筆僅參考）（30d 事件 41（截斷外推 665）／fills 2,000）|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $9,657,079 | 6% | 17.29 | 3x | @166 | 363 | ✅（30d 事件 43／fills 1,285）|
| `0xbe494a5e3a719a78a45a47ab453b7b0199b9d101` | $2,909,549 | 34% | 0.54 | 20x | HYPE | 300 | ❌ 槓桿過高：目前 20x > 10x（30d 事件 28（截斷外推 106）／fills 2,000）|
