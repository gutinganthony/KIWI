# Hyperliquid 廣域可跟錢包掃描 — 2026-09-07
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $11,362,887 | 6% | 11.15 | 10x | xyz:META | 417 | ✅（30d 事件 28／fills 852）|
| `0x016e7005d7648b3aabb8023f02601b8b9b8746b0` | $3,422,985 | 23% | — | 2x | LIT | 64 | ❌ 平均持倉時間估不出（無 Open/Close 成交可配對），保守判不可跟（30d 事件 0／fills 0）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $31,986 | 0% | 1.43 | —x | @107 | 858 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
