# Hyperliquid 廣域可跟錢包掃描 — 2026-08-18
...
| 端點 | 成功 | 失敗 | 失敗樣本 |
|---|---:|---:|---|
| `clearinghouseState @ api.hyperliquid.xyz/info` | 29 | 0 | — |
...
| `portfolio @ api.hyperliquid.xyz/info` | 29 | 0 | — |
| `spotClearinghouseState @ api.hyperliquid.xyz/info` | 3 | 0 | — |
| `userFills @ api.hyperliquid.xyz/info` | 29 | 0 | — |
| `userFunding @ api.hyperliquid.xyz/info` | 29 | 0 | — |
...
|---|---:|---:|---:|---:|---|---:|---|
| `0x8bae3527e5a33fa0cf184f37bc112d071463ab6d` | $10,138,321 | 6% | 2.73 | 10x | xyz:GOOGL | 398 | ✅（30d 事件 27（截斷外推 43）／fills 2,000）|
| `0xbe19541903f64af97bcf8436f4d15bf3a56b8bd1` | $9,921,464 | 17% | 2,523.68 | 10x | HYPE | 384 | ❌ 頻率過高：30 日推估 163 個部位事件 > 150（fills 截斷窗覆蓋 0.6 天、實測 3 個外推；fills 2000 筆僅參考）；持倉過短：平均 0.0h < 12h（30d 事件 3（截斷外推 163）／fills 2,000）|
| `0x0a0b4d654d967a00407f5329588a258b68a4f615`（⚠️ 曾強平 2 次） | $31,863 | 0% | 1.43 | —x | @107 | 839 | ❌ 持倉過短：平均 6.1h < 12h（30d 事件 0／fills 0）|
