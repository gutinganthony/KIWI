...
3. 策略 C 的 Nasdaq 專屬回測：200 日線 2000–2002 精確出場點與 1999–2005 淨值曲線（現有來源只有 S&P 500 與定性結論）。**回測程式已寫好：`drafts/gen_W8_backtest.py`（含防未來函數、日/月頻自動判定、三策略淨值＋換手紀錄＋圖1）；環境 egress 擋 FRED/Yahoo/stooq，待 Jake 上傳一份 Nasdaq Composite 日或月 CSV 即可跑出真數字。**
