# KIWI — Knowledge Index & Wiki

A personal knowledge database of articles, links, and summaries, curated with Claude.

---

## How It Works

- Drop an article or link in a Claude conversation
- Claude reads, summarizes, and commits it here
- Each entry is tagged by **topic** and **date**, with a full update log if revisited
...
| [Business](./topics/business/INDEX.md) | 82 |
...
| Date | Title | Topic |
|------|-------|-------|
| 2026-09-04 | [台灣大額資金合法化與家族資產移轉 — 稅制框架、成本試算與紅線地圖](./topics/business/2026-09-04-taiwan-cash-legitimization-and-family-asset-transfer.md) | Business |
...
| 2026-07-12 | [ABCD 自我審計 — 決策複盤 × 知識架構 × 唱反調 × 失敗預演](./topics/other/2026-07-12-decision-quality-self-audit.md) | Other |
...
| Date | Title | Topic |
|------|-------|-------|
| 2026-04-07 | [光子学供应链投资逻辑](./topics/business/2026-04-07-photonics-ai-infrastructure-investment.md) | Business |
...
*Maintained by [gutinganthony](https://github.com/gutinganthony) + Claude*
