...
- [ ] 2026-08-20 | EMA20/50 策略：要不要繼續 | 2026-07-30 實測完成（107 檔、2018→2026，詳 `projects/ema-backtest/FINDINGS.md`）。**結論：股票不能用**（101 檔 Nasdaq 成分股只有 12% 勝過買入持有，風險調整後也輸）；**只有 BTC 站得住腳**（+1,315% vs +374%，MDD −49% vs −81.5%）。決策點＝要不要為 BTC 這一個標的做樣本外驗證（2018 前資料／未參與挑選的高波動資產）。**不做驗證就別上實盤**——目前的 BTC 優勢是從 107 個結果中事後挑出來的，且 2023 起買入持有反而領先
