...
- [ ] 2026-08-15 | T1 價格型 failsafe 決策 | 2026-07-30 對抗性複審提出：T1 四條件全是滯後指標，若 6/25 已見頂，現有設計要等 2026/11–2027/01 才會響——太晚。提案「跌破 6/25 高點 X% 即機械減碼」，**要不要加、X 設多少是你的決定**，詳 `skills/serenity/exit-playbook.md` §7 第 4 項
...
- [x] 2026-07-30 | 記憶體判定重跑 | **T1 四條件：0/4 觸發（4/4 已知）→ 不減碼。** 對抗性複審（比照 7/26 方法論）推翻「信心應上升」：抓到兩個錯誤——③存貨查無數字被誤記成「未觸發」（應是「未知」）、①合約價序列其實是減速被誤讀成加速。更抓到最深問題：若 6/25 已見頂、基本面滯後 5–7 個月，本次檢定在兩個假說下都預期 0/4、資訊量趨近於零。信心維持 45–55%（不上升）。複審提案的價格型 failsafe 轉為 8/15 待決任務。完整記錄 `topics/business/2026-07-26-memory-bear-market-multifactor-verdict.md` §9
- [x] 2026-07-31 | Amazon capex 補查 | **④ 補齊：capex $200B→$220B（CEO Andy Jassy 法說會明講因「memory 成本上升」，稱 2026/2027 都不夠應付需求）**。四大 hyperscaler 全數上修、無一下修，T1 條件④確定收斂。**信心仍維持 45–55%，不因此上升**——capex 上修跟合約價一樣是滯後指標，7/30 判定的零資訊量邏輯同樣適用。
